...
export default function Home() {
	...
	return (
		<>
				...
				<main className="flex flex-col gap-8 items-center sm:items-start">
					<div className="flex gap-4 items-center justify-between w-full">
						...
						<div className="flex items-center gap-5">
							...
							<button
								className="cursor-pointer text-xl disabled:cursor-not-allowed disabled:animate-pulse"
								onClick={async () => {
									await logout().unwrap();
									r.replace("/login");
								}}
					...
					<p>
						Energy: {me.energy} • Earned: {me.earned} • x
						{me.multiplier}
					</p>
			...
			{/* Leaderboard Modal */}
			{isOpen && (
				<LeaderboardModal isOpen={isOpen} closeModal={closeModal} />
			)}
		</>
	);
}
